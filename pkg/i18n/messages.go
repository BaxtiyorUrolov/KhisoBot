...
var messages = map[string]Messages{
	"uz": {
		...
		MainMenu:          "Assalomu alaykum! Botimizga xush kelibsiz.\n\nOlimpiadaning saralash bosqichi savollari @khiso Telegram kanalida e’lon qilingan.",
	...
	"ru": {
		...
		MainMenu:          "Ассалому алайкум! Вопросы отборочного этапа олимпиады опубликованы в Telegram-канале @khiso.",
	...
	"en": {
		...
		MainMenu:          "Assalomu alaykum! Welcome to our bot.\n\nThe questions for the qualifying stage of the Olympiad have been published on the @khiso Telegram channel.",
